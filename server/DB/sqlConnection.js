...
// "CREATE TABLE IF NOT EXISTS `Password` (`ManagerId` INT NOT NULL, `Password` NVARCHAR(50) NOT NULL, PRIMARY KEY (`ManagerId`), FOREIGN KEY (`ManagerId`) REFERENCES `Manager` (`Id`));",
...
// "CREATE TABLE IF NOT EXISTS `Manager` (`Id` INT AUTO_INCREMENT NOT NULL, `FirstName` NVARCHAR(50) NOT NULL, `LastName` NVARCHAR(50) NOT NULL, PRIMARY KEY (`Id`));",
